<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item
        label="当前消息状态：0.新建 20.停用 30.启用 40.等待发送 50.发送中 60.发送成功 70.发送失败"
        prop="msgStatus"
      >
        <el-select
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column
        label="发送账号 一个渠道下可存在多个账号"
        align="center"
        prop="sendAccount"
      />
      <el-table-column label="创建时间" align="center" prop="createTime" width="180px" />
      <el-table-column
        label="10.通知类消息 20.营销类消息 30.验证码类消息"
        align="center"
        prop="msgType"
      />
      <el-table-column
        label="当前消息审核状态： 10.待审核 20.审核成功 30.被拒绝"
        align="center"
        prop="auditStatus"
      />
