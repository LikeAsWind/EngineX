<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <!-- 消息状态：0.新建 20.停用 30.启用 40.等待发送 50.发送中 60.发送成功 70.发送失败-->
      <el-form-item
        label="消息状态"
        prop="msgStatus"
      >
      ...
      <el-form-item
        label="期望发送时间：0:立即发送 定时任务以及周期任务:cron表达式"
        prop="expectPushTime"
      >
        <el-date-picker
      ...
      <el-form-item
        label="消息发送渠道：10.Email 20.短信 30.钉钉机器人 40.微信服务号 50.push通知栏 60.飞书机器人"
        prop="sendChannel"
      >
        <el-input
...
const formRules = reactive({
  ...
  msgStatus: [
    {
      required: true,
      message:
        '当前消息状态：0.新建 20.停用 30.启用 40.等待发送 50.发送中 60.发送成功 70.发送失败不能为空',
      trigger: 'blur'
    }
  ],
  pushType: [
  ...
  sendChannel: [
    {
      required: true,
      message:
        '消息发送渠道：10.Email 20.短信 30.钉钉机器人 40.微信服务号 50.push通知栏 60.飞书机器人不能为空',
      trigger: 'blur'
    }
  ],
  msgContent: [
  ...
  msgType: [
    {
      required: true,
      message: '10.通知类消息 20.营销类消息 30.验证码类消息不能为空',
      trigger: 'change'
    }
  ],
  auditStatus: [
    {
      required: true,
      message: '当前消息审核状态： 10.待审核 20.审核成功 30.被拒绝不能为空',
      trigger: 'blur'
    }
  ]
})
