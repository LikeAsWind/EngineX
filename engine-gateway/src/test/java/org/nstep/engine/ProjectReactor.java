...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "org.nstep.engine";
    private static final String ARTIFACT_ID = "engine";
    private static final String PACKAGE_NAME = "org.nstep.engine";
    private static final String TITLE = "EngineX ADMIN";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "org.nstep.engine";
        String artifactIdNew = "engine";
        String packageNameNew = "org.nstep.engine";
        String titleNew = "EngineX ADMIN";
