...
import org.nstep.engine.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import org.nstep.engine.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import org.nstep.engine.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import org.nstep.engine.module.system.convert.oauth2.OAuth2OpenConvert;
import org.nstep.engine.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import org.nstep.engine.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import org.nstep.engine.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import org.nstep.engine.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import org.nstep.engine.module.system.service.oauth2.OAuth2ApproveService;
import org.nstep.engine.module.system.service.oauth2.OAuth2ClientService;
import org.nstep.engine.module.system.service.oauth2.OAuth2GrantService;
import org.nstep.engine.module.system.service.oauth2.OAuth2TokenService;
import org.nstep.engine.module.system.util.oauth2.OAuth2Utils;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.nstep.cn"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.nstep.cn"),
