package org.nstep.engine.module.system.controller.admin.oauth2.vo.client;
...
public class OAuth2ClientRespVO {
    ...
    @Schema(description = "应用图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.nstep.cn/xx.png")
    private String logo;
    ...
    @Schema(description = "可重定向的 URI 地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.nstep.cn")
