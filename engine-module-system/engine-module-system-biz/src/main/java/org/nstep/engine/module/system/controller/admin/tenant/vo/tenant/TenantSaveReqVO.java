package org.nstep.engine.module.system.controller.admin.tenant.vo.tenant;
...
public class TenantSaveReqVO {
    ...
    @Schema(description = "租户名", requiredMode = Schema.RequiredMode.REQUIRED, example = "engine")
    ...
    @Schema(description = "绑定域名", example = "https://www.nstep.cn")
