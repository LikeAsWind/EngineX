package org.nstep.engine.module.system.controller.admin.oauth2.vo.user;
...
public class OAuth2UserInfoRespVO {
    ...
    @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "engine")
