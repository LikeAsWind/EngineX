package org.nstep.engine.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelSaveReqVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "engine源码")
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "engine")
    ...
    @Schema(description = "短信发送回调 URL", example = "http://www.nstep.cn")
