package org.nstep.engine.module.system.service.tenant;
...
import org.nstep.engine.framework.common.util.date.DateUtils;
...
import org.nstep.engine.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import org.nstep.engine.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import org.nstep.engine.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import org.nstep.engine.module.system.convert.tenant.TenantConvert;
...
import org.nstep.engine.module.system.dal.dataobject.tenant.TenantDO;
import org.nstep.engine.module.system.dal.dataobject.tenant.TenantPackageDO;
import org.nstep.engine.module.system.dal.mysql.tenant.TenantMapper;
import org.nstep.engine.module.system.enums.permission.RoleCodeEnum;
...
import org.nstep.engine.module.system.service.tenant.handler.TenantInfoHandler;
import org.nstep.engine.module.system.service.tenant.handler.TenantMenuHandler;
...
import static org.nstep.engine.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 engine.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
