package org.nstep.engine.module.system.controller.admin.permission.vo.role;
...
public class RolePageReqVO extends PageParam {
    ...
    @Schema(description = "角色名称，模糊匹配", example = "engine")
    private String name;

    @Schema(description = "角色标识，模糊匹配", example = "engine")
    private String code;
