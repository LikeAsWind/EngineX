 ...
 * 1）Spring Async：
 * {@link org.nstep.engine.framework.quartz.config.EngineAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 * 2）Spring Security：
 * TransmittableThreadLocalSecurityContextHolderStrategy
 * 和 EngineSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 */
package org.nstep.engine.framework.tenant;
