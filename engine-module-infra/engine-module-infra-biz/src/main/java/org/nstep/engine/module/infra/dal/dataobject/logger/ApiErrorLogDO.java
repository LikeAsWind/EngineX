package org.nstep.engine.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     * <p>
     * 关联 org.nstep.engine.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
