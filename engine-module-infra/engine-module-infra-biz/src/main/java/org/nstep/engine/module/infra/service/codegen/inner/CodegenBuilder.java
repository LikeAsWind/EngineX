...
import org.nstep.engine.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import org.nstep.engine.module.infra.enums.codegen.CodegenColumnListConditionEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link org.nstep.engine.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getColumnName(), "url")) {
            column.setExample("https://github.com/LikeAsWind/EngineX");
            return;
        }
        // reason
