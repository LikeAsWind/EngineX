package org.nstep.engine.module.infra.service.codegen.inner;
...
import org.nstep.engine.framework.common.exception.util.ServiceExceptionUtil;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "engine-module-${table.moduleName}/" + // 顶级模块
                "engine-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "engine-module-${table.moduleName}/" + // 顶级模块
                "engine-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "engine-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "engine-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
